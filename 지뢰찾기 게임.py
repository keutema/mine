...
def main():
    ...
    while True:
        ...
        for event in pygame.event.get(): 
            ...
            #되나
            time_since_enter = pygame.time.get_ticks() - STARTTIME
            if time_since_enter > 1000:
                STARTTIME = pygame.time.get_ticks()
                SECOND += 1
            
            
        message = BASICFONT.render('time:' + str(SECOND),True, (0,0,0))
        DISPLAYSURFACE.blit(message,(20,20))
